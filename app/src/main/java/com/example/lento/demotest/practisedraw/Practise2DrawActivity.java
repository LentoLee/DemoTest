package com.example.lento.demotest.practisedraw;
...
public class Practise2DrawActivity extends BaseActivity {
    TabLayout tabLayout;
    ViewPager pager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practise_2_draw);
