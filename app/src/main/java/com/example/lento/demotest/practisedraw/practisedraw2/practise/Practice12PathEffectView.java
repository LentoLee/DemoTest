...
public class Practice12PathEffectView extends View {
...

    {
        ...
        dashPath.close();
        pathDashPathEffect = new PathDashPathEffect(dashPath, 50, 50, PathDashPathEffect.Style.MORPH);
    ...
    DashPathEffect dashPathEffect = new DashPathEffect(new float[]{30, 5, 5, 5}, 0);
