...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader dst = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader src = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader cmp = new ComposeShader(dst, src, PorterDuff.Mode.DST_IN);
        paint.setShader(cmp);
    }
